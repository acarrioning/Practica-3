...
describe("Missiles testing", function(){
    ...
    it("Creamos missiles", function(){


    });

    it("Misil se eliminina al salir del canvas", function(){


    });

    it("hay que soltar la tecla de disparo", function(){
